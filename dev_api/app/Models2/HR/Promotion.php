...
class Promotion extends Model
{
    ...
    protected $fillable = [
        'promotion_id', 'employee_id', 'promotion_by','current_department','current_designation','current_pay_grade',
    ...
    public function promotionBy()
    {
        return $this->belongsTo(Employee::class,'promotion_by');
    }
