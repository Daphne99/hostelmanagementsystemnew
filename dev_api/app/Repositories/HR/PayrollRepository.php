...
use App\Models2\HR\EmployeeAttendanceApprove;
use App\Models2\HR\SalaryDeductionForLateAttendance;

use App\Models2\HR\PayGradeToAllowance;

use App\Models2\HR\PayGradeToDeduction;

use Illuminate\Support\Facades\DB;

use App\Models2\HR\TaxRule;
...
class PayrollRepository
{
    ...
    {
        return  PayGradeToAllowance::select('hr_allowance.*')
                                     ->join('hr_allowance', 'hr_allowance.allowance_id', '=', 'hr_pay_grade_to_allowance.allowance_id')
    ...
    {
        return  PayGradeToDeduction::select('hr_deduction.*')
                                    ->join('hr_deduction', 'hr_deduction.deduction_id', '=', 'hr_pay_grade_to_deduction.deduction_id')
                                    ->where('pay_grade_id',$pay_grade_id)->get();
    }
