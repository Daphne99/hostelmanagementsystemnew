var CuteBrains = angular.module('institutionTimetableClasswiseController', []);

CuteBrains.controller('institutionTimetableClasswiseController', function(dataFactory,$rootScope,$scope,$sce,$filter) {
