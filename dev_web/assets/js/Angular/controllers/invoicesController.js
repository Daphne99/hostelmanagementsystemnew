...
CuteBrains.controller('invoicesController', function(dataFactory,$scope,$sce,$rootScope,$route) {
    ...
    $scope.listUnPaidInvoices = function(pageNumber){
        showHideLoad();
    ...
    $scope.searchDB = function(pageNumber){
        showHideLoad();
        $scope.searchInput.text = $scope.searchText;
        if(window.location.href.split("/").pop() == 'paid')
        {
            dataFactory.httpRequest('index.php/invoices/listPaid/'+pageNumber,'POST',{},{'searchInput':$scope.searchInput}).then(function(data) {
                $scope.invoices = data.invoices;
                $scope.paidInvoices = data.invoices;
                $scope.totalItems = data.totalItems;
                showHideLoad(true);
        ...
        else if(window.location.href.split("/").pop() == 'unpaid')
        {
            dataFactory.httpRequest('index.php/invoices/listUnPaid/'+pageNumber,'POST',{},{'searchInput':$scope.searchInput}).then(function(data) {
                $scope.invoices = data.invoices;
                $scope.paidInvoices = data.invoices;
                $scope.totalItems = data.totalItems;
                showHideLoad(true);
    ...
    $scope.getResultsPage = function(id){
        if(typeof id == "undefined") { id = $scope.cur_page; }
        $scope.cur_page = id;
        ...
        {
            if(window.location.href.split("/").pop() == "unpaid") { $scope.listUnPaidInvoices(id); }
            else if(window.location.href.split("/").pop() == "paid") { $scope.listPaidInvoices(id); }
