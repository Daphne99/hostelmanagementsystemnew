...
<head>
    ...
    <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
		...
		<![endif]-->
		<style type="text/css">
			.login-register { margin-top: -110px; }
			@media screen and (min-width: 992px) {
				.login-box { position: absolute; right: 40px; background: floralwhite; /*box-shadow: 0 0 2px #EEE;*/ }
				.loginMark { background-size: contain !important; background-color: #FFF !important; }
			}
		@media screen and (max-width: 992px) { .login-register { margin-top: 65px !important; } }
	</style>
</head>

<?php
    $bgStyling = "";
    if($panelInit->settingsArray['authPageImage'] == "1") { $bgStyling .= "background-image:url('".URL::asset('assets/images/login-register-demo.jpg')."?v60'); "; }
