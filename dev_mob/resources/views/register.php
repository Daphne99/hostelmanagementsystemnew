...
<body class="loginMark" ng-app="CuteBrains" ng-controller="registeration" style="<?php echo $bgStyling; ?>;background-attachment:fixed; background-repeat: repeat-y;background-size: cover;">
    <!-- ============================================================== -->
    ...
    <script src="<?php echo URL::asset('/assets'); ?>/js/CuteBrains.js" type="text/javascript"></script>
