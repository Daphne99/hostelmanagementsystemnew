...
<head>
    ...
    <title>CuteBrains Upgrade</title>
    <!-- Bootstrap Core CSS -->
    ...
    <section id="wrapper">
        <div class="login-register"  >
            ...
            <div class="card-block">
                <p class="login-box-msg text-center">Upgrade to CuteBrains 5.1</p>
                <form action="{{URL::to('/upgrade')}}" method="post">
                    ...
                    <div class="body">
                        ...
                        @if($currStep == "welcome")
                            <center>Thank you for choosing CuteBrains for your school administration.
                            <br/>
                            <?php
                              if(isset($loginError)){
                            ...
                            ?>
                            Please login with administrator account to start CuteBrains upgrade</center>
                        ...
                        @if($currStep == "3")
                            <div class="form-group">
                                <center><b>Thank You for upgrading CuteBrains</b></center>
                            </div>
                            <a href="<?php echo URL::to('/'); ?>" class="btn btn-primary btn-block btn-flat">Start using CuteBrains</a>
                        @endif
                    </div>
                    <div>
