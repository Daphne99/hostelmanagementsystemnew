        ...
        <div <?php if($panelInit->settingsArray['loginPageStyle'] == "r"){ echo 'class="login-box card"'; }else{ echo 'class="login-register" '; } ?> >
            ...
            <div class="card-block">
                <form class="form-horizontal form-material" id="loginform" action="{{URL::to('/login')}}" method="post">
                    ...
                    @if($errors->any())
                        <span style='color:red; margin-bottom: -16px;margin-top: 10px;color: red;display: block;'>{{$errors->first()}}</span>
                    @endif
                    <?php
                    ...
                    <div class="form-group" style="margin-top: 30px">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="email" style="background: #FFF; padding-left: 8px" required="" placeholder="{{ $username_placeholder }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
	                            <input class="form-control" type="password" name="password" style="background: #FFF; padding-left: 8px" required data-toggle="password" placeholder="{{ $password_placeholder }}">
                    ...
                    <div class="form-group">
                    	<div class="checkbox checkbox-success p-t-0 mb-3">
                          <input id="checkbox-signup" name="remember_me" type="checkbox">
                          <label for="checkbox-signup" style="color: #2d2d2d"> <?php echo $panelInit->language['rememberMe']; ?> </label>
                      </div>
                      <a href="{{URL::to('/forgetpwd')}}" class="text-danger" style="display: block;">
                      	<i class="fa fa-lock m-r-5"></i> Forgot password?
                      </a>
                    </div>
                    <div class="form-group text-center m-t-5">
                      <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                      <button class="btn btn-success btn-lg btn-block text-uppercase waves-effect waves-light" data-ripple type="submit">
                    ...
                    <hr>
                    <div style="text-align: center; display: inline-block; color: #2d2d2d">
                        Powered by Virtu Information Technologies Pvt Ltd<br>
                        <img src="{{ asset('assets/images/logo_VirtuIT-180.png') }}" width="80px" style="margin-top: 7px">
                    </div>
