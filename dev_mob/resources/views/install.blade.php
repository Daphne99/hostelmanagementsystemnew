...
<head>
    ...
    <title>CuteBrains Installation</title>
    <!-- Bootstrap Core CSS -->
                ...
                <form action="{{URL::to('/install')}}" method="post">
                    ...
                    <div class="body">
                        ...
                        @if($currStep == "welcome")
                            ...
                            <br/>
                            Please follow the next steps to complete CuteBrains installation</center>
                            <br/>
                        ...
                        @if($currStep == "3")
                            <div class="form-group">
                                <center><b>Thank You for installing CuteBrains</b></center>
                            </div>
                            <a href="<?php echo URL::to('/'); ?>" class="btn bg-olive btn-block">Start using CuteBrains</a>
                        @endif
                    </div>
