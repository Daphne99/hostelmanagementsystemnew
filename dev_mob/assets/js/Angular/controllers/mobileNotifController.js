var CuteBrains = angular.module('mobileNotifController', []);

CuteBrains.controller('mobileNotifController', function(dataFactory,$rootScope,$route,$scope,$location,$routeParams) {
    $scope.messages = {};
    $scope.views = {};
    $scope.form = {};
