var CuteBrains = angular.module('staffAttendance_reportController', []);

CuteBrains.controller('staffAttendance_reportController', function(dataFactory,$scope,$rootScope) {
    $scope.views = {};
