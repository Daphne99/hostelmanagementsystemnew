var CuteBrains = angular.module('teacherLogsController', []);

CuteBrains.controller('teacherLogsController', function(dataFactory,$rootScope,$scope,$sce) {
    $scope.views = {};
    ...
    $scope.$on('$viewContentLoaded', function() {
    	document.title = $('meta[name="site_title"]').attr('content') + ' | Teacher logs';
    });
    ...
    $scope.load_data = function(pageNumber) {
        ...
        showHideLoad();
        dataFactory.httpRequest('index.php/user-logs/listAll/'+pageNumber,'POST',{},{'searchInput': {
        	user_role: 'teacher',
        	module: ['Homework', 'Attendance', 'Assignments']
        }}).then(function(data) {
