...
CuteBrains.controller('assignmentsController', function(dataFactory,$rootScope,$scope) {
    $scope.classes = {};
    $scope.subject = {};
    $scope.section = {};
    $scope.assignments = {};
    ...
    $scope.zoomIn = function(){
        $(".image-item").width( $(".image-item").width() * 1.1 )
        $(".image-item").height( $(".image-item").height() * 1.1 );
    }

    $scope.zoomOut = function(){
        if($(".image-item").width() > $(window).width())
        {
            $(".image-item").width( $(".image-item").width() * 0.9 );
            $(".image-item").height( $(".image-item").height() * 0.9 );
    	}
    }
