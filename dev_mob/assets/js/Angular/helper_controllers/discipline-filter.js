CuteBrains.controller('disciplinesFilterController', function(dataFactory,$rootScope,$route,$scope,$location,$routeParams) {
	  $scope.filter_view = {};
	  $scope.classes = {};
	  $scope.sections = {};
	  $scope.subjects = {};
	  ...
	  $scope.fetchComplainedByUsersByWord = function() {
	  ...
	  $scope.fetchJuryUsersByWord = function() {
	  ...
	  $scope.fetchResponsibleOfficialsUsersByWord = function() {
